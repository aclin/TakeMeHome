...
-(void)customizeiPhoneTheme
{
    ...
    UIImage *navBarImage = [[UIImage imageNamed:@"menubar2.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(5, 15, 5, 15)];
    ...
    //UIImage* tabBarBackground = [UIImage imageNamed:@"tabbg2.png"];
   // [[UITabBar appearance] setBackgroundImage:tabBarBackground];
    
    
    [[UITabBar appearance] setSelectionIndicatorImage:[UIImage imageNamed:@"bottomfocus.png"]];
